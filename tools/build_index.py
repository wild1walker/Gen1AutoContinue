...
LISTING = {
    "summary": "Boot to title, one press, playing. Skips the intro, the "
               "CONTINUE / NEW GAME menu and the save-info window.",
    "categories": ["QOL", "UI"],
    "tags": ["quality of life", "ui", "boot"],
    "license": "MIT",
}
...
def build():
    ...
    thumbnail = ROOT / "site" / "data" / "thumbnail.png"
    if thumbnail.exists():
        entry["thumbnail"] = f"{raw}/site/data/thumbnail.png"
